...
class NetworkTrainer:
    ...
    def get_noise_pred_and_target(
        ...
        if args.gradient_checkpointing:
            ...
            for t in uncond_text_encoder_conds:
                t.requires_grad_(True)
        ...
        with torch.set_grad_enabled(is_train), accelerator.autocast():
            ...
            uncond_noise_pred = self.call_unet(
                args,
                accelerator,
                unet,
                noisy_latents.requires_grad_(train_unet),
            ...
            combined_noise_pred = uncond_noise_pred + (noise_pred - uncond_noise_pred) * 8 # hardcoded for now
        ...
        return combined_noise_pred, target, timesteps, None
        ...
        if len(text_encoder_conds) == 0 or text_encoder_conds[0] is None or train_text_encoder:
            ...
            with torch.set_grad_enabled(is_train and train_text_encoder), accelerator.autocast():
                ...
                if args.weighted_captions:
                    ...
                    uncond_input_ids = [ids.to(accelerator.device) for ids in batch["uncond_input_ids_list"]]
                    uncond_encoded_text_encoder_conds = text_encoding_strategy.encode_tokens(
                        tokenize_strategy,
                        self.get_models_for_text_encoding(args, accelerator, text_encoders),
                        uncond_input_ids,
                    )
            ...
            if len(text_encoder_conds) == 0:
                ...
                uncond_text_encoder_conds = uncond_encoded_text_encoder_conds
            else:
                ...
                if accelerator.sync_gradients:
                    ...
                    if global_step % 20 == 0:
                        ...
                        if ckpt_loss*1.0 >= current_loss:
                            ...
                            args.unet_lr = args.unet_lr*1.03*reduce_lr
                            args.learning_rate = args.learning_rate*1.03*reduce_lr
                            ...
                            args.unet_lr = args.unet_lr*0.99*reduce_lr
                            args.learning_rate = args.learning_rate*0.99*reduce_lr
